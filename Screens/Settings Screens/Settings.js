...
import { Container,Text, List, ListItem, Content, Body,Left,Thumbnail} from "native-base";
...
<Container>
        <Content>
          <List>
            <ListItem avatar onPress={() => navigation.navigate("AccountSettings")}>
              <Left>
            ...
            <ListItem avatar onPress={() => navigation.navigate("LocationSettings")}>
              <Left>
